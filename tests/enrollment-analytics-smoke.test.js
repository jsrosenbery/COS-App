...
test('faculty schedule heatmap is a standalone Development report', () => {
  ...
  assert.match(text, /Overall Faculty Schedule Heatmap/);
  assert.match(text, /Full-Time Faculty Schedule Heatmap/);
  assert.match(text, /Part-Time Faculty Schedule Heatmap/);
