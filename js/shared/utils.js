...
(function () {
  ...
  const commonAnalyticsDefinitions = [
    ...
    ['Seat Choice Count', 'Total section capacity offered in a day/time block.'],
    ['Modality Choice Count', 'Number of distinct reportable modality categories represented in a day/time block.'],
    ...
    ['Course Duration Heatmap', 'Active distinct CRN/day/start/end blocks in each overlapping half-hour interval. Duplicate rows for the same CRN/day/start/end count once.'],
    ...
    ['Faculty Count', 'Distinct faculty represented in a day/time block after omitted faculty rows are excluded.'],
  ...
  window.COSUtils = {
    ...
    formatters: window.COSFormatters,
    formatWholeNumber: window.COSFormatters?.formatWholeNumber,
    formatDecimal: window.COSFormatters?.formatDecimal,
    formatPercent: window.COSFormatters?.formatPercent,
    formatFactor: window.COSFormatters?.formatFactor,
    formatPresenceValue: window.COSFormatters?.formatPresenceValue,
