...
(function () {
  ...
  const commonAnalyticsDefinitions = [
    ...
    ['Student Presence', 'Estimated students physically scheduled in a time block. Uses census enrollment when available, otherwise actual/current enrollment, and applies that enrollment once per active distinct CRN/day/start/end block.'],
