(function (root, factory) {
  ...
  const fields = {
    ...
    census2: ['census2', 'censusEnrollment2', 'Census 2', 'Census_2', 'CENSUS_2', 'CENSUS_ENROLL2', 'Census Enroll 2', 'Census Enrollment 2'],
    partOfTerm: ['partOfTerm', 'Part of Term', 'PART OF TERM', 'PART_OF_TERM', 'POT', 'PTRM', 'PTRM CODE', 'PTRM_CODE'],
    activityDate: ['activityDate', 'Activity Date', 'ACTIVITY_DATE', 'ACTIVITY DATE'],
  ...
  function normalizeCsvRow(row, options = {}) {
    ...
    return {
      ...
      censusEnrollmentDate: extractField(row, fields.censusEnrollmentDate),
      censusEnrollment: nullableNumber(extractField(row, fields.census)),
      censusEnrollment2Date: extractField(row, fields.census2Date),
      censusEnrollment2: census2Raw != null && census2Raw < 0 ? null : census2Raw,
      snapshotDate: extractField(row, fields.snapshotDate),
